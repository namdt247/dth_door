...
<head>
    ...
    <link rel="stylesheet" href="/admin/assets/vendor/@fortawesome/fontawesome-free/css/all.min.css"><!-- END PLUGINS STYLES -->
    <!-- BEGIN THEME STYLES -->
...
<body>
    <main class="auth">
        <header id="auth-header" class="auth-header" style="background-image: url(assets/images/illustration/img-1.png);">
            <h1>
                <img src="/admin/assets/logo_admin.png" alt="" height="84">
...
{{--                <span class="sr-only">Sign In</span>--}}
            ...
            <p> Don't have a account? <a href='#'>Contact now</a>
            </p>
        </header><!-- form -->
        <form class="auth-form" method="post" action="/admin/login">
            ...
            <div class="text-center pt-3">
                <a href="#" class="link">Forgot Username?</a> <span class="mx-2">·</span> <a href="#" class="link">Forgot Password?</a>
            </div><!-- /recovery links -->
        </form><!-- /.auth-form -->
        <!-- copyright -->
    ...
    <!-- BEGIN THEME JS -->
    <script src="/admin/assets/javascript/theme.js"></script> <!-- END THEME JS -->
</body>
</html>
